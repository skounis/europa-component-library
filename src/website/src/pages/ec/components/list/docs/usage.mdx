...
<Paragraph size="lead">
  Lists group together related information. They are scannable, well-structured and semantical.
</Paragraph>

## Anatomy

A list is a series of continuous items displayed in a column made up of subdivisions called rows.
